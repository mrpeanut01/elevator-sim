...
| Next free decision number | **D355** — D346 write-disclosure, D347 the gate's own hole, D348 #200 into M2, D349 M2's two halves, D350 #217 split, and wave B's four: D351 the count bound to `data/`, D352 the withdrawn 1280 px rule, D353 the tier's `port: 0` mechanism, D354 the honest speed ladder |
