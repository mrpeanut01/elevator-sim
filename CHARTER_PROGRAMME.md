...
| Next free decision number | **D620** — of this wave's reserved block **D615–D620**, D615, D618 and D619 are spent. Spent: **D615** (#540, the revert procedure's step 2 made structurally safe), **D618** (#408, charter S9 B1's run-history store and rolling gate), **D619** (#422, fix-a-building's elevation control and its price-schedule row). **D616 and D617 are registered permanently as holes** — the #540 lane was redone from a stale base, and its discarded first attempt used those two numbers before the redo consolidated onto D615 alone. **D620 is free rather than a hole**, because nothing above D619 was ever written — a #242 (error monitoring) lane that would have used D619–D620 was dropped after finding the issue already substantially resolved by merged PR #482, with only Azure-credential and legal-review work left outstanding, neither of which this wave could do. The previous wave's block was **D594–D620** and spent thirteen, with D602–D605 and D607–D610 registered as holes. |
