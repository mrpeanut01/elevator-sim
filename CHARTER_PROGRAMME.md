...
| Next free decision number | **D557** — the floor of the **D557–D580** block reserved for **wave Z of 2026-09-14**, which is still open (`documentation.test.ts#OPEN_RESERVATION`). The row names the floor until the wave closes, when every unspent number is registered as a hole and the row moves to the highest plus one. The block is dispatched per lane: D557–D559 lane A (GitHub issue #537), D560–D562 lane B (#528), D563–D567 lane C (#531, #533, #535), D568–D571 lane D (#534), D572–D576 lane E (#500, #501), and **D577–D580 the integrator’s** — the sizing rule § D418’s note asked the next wave to apply, since an integrator who works during a wave needs numbers too. Before this row read **D533**, the floor of the D533–D556 block reserved for the wave of 2026-09-10 and widened on 2026-09-11. **That block is now closed.** It spent fifteen of its twenty-four numbers — D533, D535, D537, D538, D539, D542, D543, D545, D547, D548, D549, D552, D553, D555 and D556 — and the nine it never reached (D534, D536, D540, D541, D544, D546, D550, D551, D554) are registered permanently as holes in `documentation.test.ts#KNOWN_DECISION_HOLES` rather than returned to the pool, because ids here are names (§ D430) and a number reported unspent denotes what that lane took. Before the wave the row read **D533** — **D532 was taken by GitHub issue #413's lane** (the replication-block fan-out, `docs/15` Phase B) from the D532–D535 block reserved to it; D533–D535 were not spent, and whether they return to the pool is the integrator's call under § D404. Before that the row read **D532** — **D528 to D531 were taken outside a wave on 2026-09-06 by the product owner**, in the same conversation that produced D525–D527 and after a review of all twelve of [`docs/33`](docs/33-difficulty-curve.md)'s difficulty rules that the owner asked for: D528 difficulty is the survivor count with the budget as a third substrate and four rules folded into one measurement, D529 the first session is a two-screen tutorial and a worked answer is permitted there and nowhere else, D530 the cross-mode currency is named **chimes**, D531 the sign-in bonus ships at launch — the last two closing both of § D526's open items, so [`docs/38`](docs/38-what-the-game-is.md) § 5 now has none. D528–D530 were three of the six numbers wave X returned unreached; **D531 is the first past that reservation**, which is why the row moves to D532 rather than staying inside it. Before that the row read **D528**, after D525–D527 were taken by the owner — and those three were first drafted as D497–D499 on a branch that had not seen waves T to X, which is § D404's warning arriving on the owner's own desk. Wave X reserved **D521–D530** and spent **four** (§ D521 #222, § D522 #328, § D523 #346, § D524 #346); the six it returned unreached are now all spent. Wave W before it reserved D514–D530 and spent seven |
