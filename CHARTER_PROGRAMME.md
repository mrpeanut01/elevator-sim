...
| Next free decision number | **D619** — of this wave's reserved block **D615–D620**, D615 and D618 are spent. Spent: **D615** (#540, the revert procedure's step 2 made structurally safe), **D618** (#408, charter S9 B1's run-history store and rolling gate). **D616 and D617 are registered permanently as holes** — the #540 lane was redone from a stale base, and its discarded first attempt used those two numbers before the redo consolidated onto D615 alone. **D619 and D620 are free rather than holes**, because nothing above D618 was ever written — a #242 (error monitoring) lane that would have used them was dropped after finding the issue already substantially resolved by merged PR #482, with only Azure-credential and legal-review work left outstanding, neither of which this wave could do. The previous wave's block was **D594–D620** and spent thirteen, with D602–D605 and D607–D610 registered as holes. |
