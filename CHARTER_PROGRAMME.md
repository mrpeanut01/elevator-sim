...
| Next free decision number | **D583** — wave AA of 2026-09-15 has spent D576–D582 (lane A, GitHub issues #425, #424 and #430), and this row is reconciled on the same commit that spent them. Nothing in D576–D582 is a hole: the block was D576–D600 and lane A used its floor seven numbers sequentially, so the free number is the one above the highest written. The paragraph below is wave Z's and is kept as the dated record it is. **D576** was the floor then — wave Z of 2026-09-14 is **closed**, and this row is reconciled on the same commit that closed it, which is the step D387 records that nobody performs when nothing asks — written bare, because D387 is a registered hole, a hole heads nothing, and `citations.test.ts` resolves every `§ Dnnn` to a heading. This row went red for exactly that on the commit that closed the wave, which makes the integrator the **fifth** consecutive author to break the convention inside the sentence explaining it. A convention five authors break while describing it is not held by care, which is the argument for the guard. The block was **D557–D580** and spent fourteen: D557 (lane A, GitHub issue #537), D560 (lane B, #528), D563–D567 (lane C, #531, #533, #535), D568–D571 (lane D, #534) and D572–D575 (lane E, #500, #501). **D558, D559, D561 and D562 are registered permanently as holes** in `documentation.test.ts#KNOWN_DECISION_HOLES`, because each sits below a higher number its own lane went on to write. **D576–D580 are free rather than holes** — the integrator’s tail went unspent and nothing above them was ever written, so this row names D576 rather than pointing past a gap; only a number written below a higher one is a hole (§ D430). Two lanes independently widened the previous block before this one was opened, which is recorded in `documentation.test.ts` as the measurement behind the rule that a block is opened before its lanes start. Before this row read **D533**, the floor of the D533–D556 block reserved for the wave of 2026-09-10 and widened on 2026-09-11; that block spent fifteen of its twenty-four and its nine unreached numbers (D534, D536, D540, D541, D544, D546, D550, D551, D554) are registered as holes. |
