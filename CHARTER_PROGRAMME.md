...
| Next free decision number | **D1048** — no wave is open. **Take your numbers from your dispatch brief, never from this row**: it is the integrator's input and is stale while a wave runs, which is why two lanes reading it once both computed § D336. Wave AI held D1002–D1055 in six blocks, spent eleven headings (D1002–D1004, D1011, D1020, D1029, D1038–D1041, D1047), registered thirty-five holes and closed its reservation in its own merge commit; D1048–D1055 were free rather than holed (§ D430). A wave's merge commit closes every reservation it opened, the fix block included. |
