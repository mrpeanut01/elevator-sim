...
| Next free decision number | **D531** — **D528, D529 and D530 were taken outside a wave on 2026-09-06 by the product owner**, in the same conversation that produced D525–D527 and after a review of all twelve of [`docs/33`](docs/33-difficulty-curve.md)'s difficulty rules that the owner asked for: D528 difficulty is the survivor count with the budget as a third substrate and four rules folded into one measurement, D529 the first session is a two-screen tutorial and a worked answer is permitted there and nowhere else, D530 the cross-mode currency is named **chimes**. They are three of the six numbers wave X returned unreached, which leaves **D531** free and the reservation spent. Before that the row read **D528**, after D525–D527 were taken by the owner — and those three were first drafted as D497–D499 on a branch that had not seen waves T to X, which is § D404's warning arriving on the owner's own desk. Wave X reserved **D521–D530** and spent **four** (§ D521 #222, § D522 #328, § D523 #346, § D524 #346); the six it returned unreached are now all spent. Wave W before it reserved D514–D530 and spent seven |
