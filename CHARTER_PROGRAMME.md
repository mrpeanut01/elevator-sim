...
| Next free decision number | **D594** — wave AA of 2026-09-15 is **closed**, and this row is reconciled on the same commit that closed it, which is the step D387 records that nobody performs when nothing asks (written bare: D387 is a registered hole, a hole heads nothing, and `citations.test.ts` resolves every section reference to a heading). The block was **D576–D600** and spent thirteen: D576–D582 lane A (GitHub issues #425, #424, #430), D583 lane B (#433), D587–D588 lane C (#355, #242, #243), D591–D593 lane D (#406). **D584, D585, D586, D589 and D590 are registered permanently as holes**, each sitting below a higher number a sibling lane went on to write; **D594–D600 are free**, nothing above them having been written. Two lanes each reported their own returned numbers as free and both were wrong, because free-versus-hole depends on what lands after you — which is why that call is the integrator’s at close. |
