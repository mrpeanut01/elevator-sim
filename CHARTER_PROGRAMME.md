...
| Next free decision number | **D594** — the floor of the **D594–D620** block reserved for **wave AB of 2026-09-15**, which is still open (`documentation.test.ts#OPEN_RESERVATION`). Dispatched per lane: D594–D600 lane A (GitHub issues #426, #427, #428), D601–D605 lane B (#429), D606–D610 lane C (#372), D611–D615 lane D (#234), and **D616–D620 the integrator’s**. Wave AA before it reserved D576–D600 and spent thirteen; D584, D585, D586, D589 and D590 are registered holes, and D594–D600 were free rather than holes, which is why this block reuses D594 as its floor. |
