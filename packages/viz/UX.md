...
| RX-04 | < 1180 px | The building's spec line, the phase pill, the mode select and the banner step aside — the name outranks the spec | ✅ run for the spec line (drive: shown at 1180, gone at 1179) · ⚠️ (the phase pill, the mode select and the banner were not individually probed) |
