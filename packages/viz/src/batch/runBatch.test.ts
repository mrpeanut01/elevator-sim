...
/** The seed every measurement in this file and in `DECISIONS.md` § D155 was taken at. */
...
describe('suppression propagates from the replication to the batch', () => {
  ...
  it('Midtown Office at 50: shipped demand suppresses every estimate; a lower demand does not', () => {
     ...
     * anticipate — recorded in `DECISIONS.md` § D155. At Midtown's own traffic profile the batch
