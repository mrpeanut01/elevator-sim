 ...
 * [`DECISIONS.md` § D125](../../../../DECISIONS.md): `runner/` was audited by **neither**. `core`'s
 ...
 * forces the allowlist entry — and § D125's exemption — to be re-argued rather than silently
...
describe('every export of runner/ has a caller or a stated reason', () => {
   ...
   * of § D125's exemption rests on the second half of that sentence. If a study ever injects a
  ...
  it('pins the exemption: the composed stopping rule still has no non-test caller', () => {
    ...
    expect(
      ...
      'a study now injects a stopping rule. DECISIONS.md § D125 exempted the port on the ground ' +
