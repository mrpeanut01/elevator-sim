...
| S2 | **Yes — and unevaluated** | 2026-09-10 | Same instrument. `docs/26 K2`’s five-beat chain is emitted from four shipped screens; the one beat with no event is *diagnose*, which happens in the player’s head and which § 6.2 refuses to assert an event about |
