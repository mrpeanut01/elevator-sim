...
2. #191's list names five beats and no time budget. The handoff supplies one — *~5 min a case*
   ...
   shipped build does not meet it, by a factor of three at the bottom and about thirty-six at the
   top**.
   ...
   **8 min-1 h 49 a day at 4×**, with the hours between the day's peaks played at `30×`. **The
   ...
   ships no day for. **It then read *8 min-2 h 30* and the factor *fifty*, until
   [§ D991](../DECISIONS.md)** (GitHub issue #592): the whole day is still played and graded whole,
   but the stage plays its three peaks at the player's rung and crosses the hours between them at
   `30×`, dropping back while anyone on a landing has waited past a minute. **The top of the range
   is measured over every contract rather than taken from the ruling's estimate** — sixteen
   contracts × fifty seeds — and it is a reference tower's: about 109 minutes, because its
   landings hold somebody past a minute for most of the day. On the game's own towers the longest
   day measured is **51 minutes**. A
