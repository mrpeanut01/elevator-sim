 ...
 * | annotations | 529 | 207 |
 * | above its own ceiling | **112** | **91** |
 * | at its own ceiling | 223 | 113 |
 ...
 * seven browser cases and misses the **84** that sit above the tier's own ceiling, including **37**
 ...
 * rather than typed: `packages/viz` carries **736** timeout annotations in all, of which **260**
