 ...
 * | annotations | 534 | 215 |
 * | above its own ceiling | **112** | **97** |
 * | at its own ceiling | 227 | 115 |
 * | above 300 000 ms | 112 | 7 |
 *
 ...
 * seven browser cases and misses the **90** that sit above the tier's own ceiling, including **43**
 ...
 * rather than typed: `packages/viz` carries **749** timeout annotations in all, of which **270**
