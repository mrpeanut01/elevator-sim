 ...
 * | annotations | 511 | 196 |
 * | above its own ceiling | **111** | **82** |
 * | at its own ceiling | 209 | 111 |
 * | above 300 000 ms | 111 | 7 |
 *
 ...
 * seven browser cases and misses the **75** that sit above the tier's own ceiling, including **31**
 ...
 * rather than typed: `packages/viz` carries **707** timeout annotations in all, of which **240**
