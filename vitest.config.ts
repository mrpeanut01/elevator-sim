 ...
 * | annotations | 497 | 182 |
 * | above its own ceiling | **105** | **73** |
 * | at its own ceiling | 204 | 106 |
 * | above 300 000 ms | 105 | 4 |
 *
 ...
 * rather than typed: `packages/viz` carries **679** timeout annotations in all, of which **231**
