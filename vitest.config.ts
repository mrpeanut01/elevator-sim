 ...
 * | annotations | 556 | 232 |
 * | above its own ceiling | **117** | **98** |
 * | at its own ceiling | 235 | 131 |
 * | above 300 000 ms | 117 | 8 |
 *
 ...
 * rather than typed: `packages/viz` carries **788** timeout annotations in all, of which **278**
