 ...
 * | annotations | 541 | 215 |
 * | above its own ceiling | **116** | **97** |
 * | at its own ceiling | 230 | 115 |
 * | above 300 000 ms | 116 | 7 |
 *
 ...
 * rather than typed: `packages/viz` carries **756** timeout annotations in all, of which **273**
